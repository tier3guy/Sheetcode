      ...
      <main className="w-100 px-10">
        <div className="w-100 flex justify-between items-center gap-[50px]">
          <div>
            ...
            <p className="w-[90%] text-gray-500">
              ...
              (DSA) problems, tailored to help students hone their
              problem-solving skills and excel in coding interviews. Practice
              with handpicked challenges, receive personalized feedback, and
              embark on a journey to become a coding maestro. Are you ready to
              conquer DSA like a pro? Join Sheetcode today!
            </p>
        ...
        >
          ...
          <div>
            ...
            <p className="w-[90%] text-gray-500">
              Welcome to Sheetcode. , your ultimate destination for mastering
              Data Structures and Algorithms (DSA) with ease and efficiency.
              Founded by
              ...
              , two passionate developers and lifelong friends, this platform
              was born out of a shared dream to create an inclusive and
              comprehensive resource for all aspiring programmers and coding
              enthusiasts.
            </p>
            <p className="w-[90%] text-gray-500 mt-4">
              At Sheetcode. , we firmly believe that the journey of becoming an
              exceptional coder should be both enjoyable and rewarding. Our
              vision is to empower learners worldwide with the knowledge, tools,
              and confidence to tackle complex coding challenges and unlock
              their full potential. We aim to bridge the gap between theoretical
